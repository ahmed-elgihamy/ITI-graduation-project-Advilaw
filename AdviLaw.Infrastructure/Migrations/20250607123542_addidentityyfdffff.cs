...
{
    /// <inheritdoc />
    public partial class addidentityyfdffff : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlatformSubscriptionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionPoints_PlatformSubscriptions_PlatformSubscriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Jobs_JobFields_JobFieldId",
                        column: x => x.JobFieldId,
                        principalTable: "JobFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Jobs_Lawyers_LawyerId",
                        column: x => x.LawyerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LawyerJobFields", x => new { x.LawyerId, x.JobFieldId });
                    table.ForeignKey(
                        name: "FK_LawyerJobFields_JobFields_JobFieldId",
                        column: x => x.JobFieldId,
                        principalTable: "JobFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LawyerJobFields_Lawyers_LawyerId",
                        column: x => x.LawyerId,
                        principalTable: "Lawyers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sessions_Lawyers_LawyerId",
                        column: x => x.LawyerId,
                        principalTable: "Lawyers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_AspNetUsers_ReceiverId1",
                        column: x => x.ReceiverId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_AspNetUsers_SenderId1",
                        column: x => x.SenderId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_ReceiverId1",
                        column: x => x.ReceiverId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_SenderId1",
                        column: x => x.SenderId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewerId1 = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_RevieweeId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EscrowTransactions_AspNetUsers_SenderId1",
                        column: x => x.SenderId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EscrowTransactions_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EscrowTransactions_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSubscriptions_Lawyers_LawyerId",
                        column: x => x.LawyerId,
                        principalTable: "Lawyers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserSubscriptions_PlatformSubscriptions_SubscriptionTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EscrowTransactions_JobId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EscrowTransactions_SenderId1",
                table: "EscrowTransactions",
                column: "SenderId1");

            migrationBuilder.CreateIndex(
                name: "IX_EscrowTransactions_SessionId",
                table: "EscrowTransactions",
                column: "SessionId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jobs_JobFieldId",
                table: "Jobs",
                column: "JobFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_LawyerId",
                table: "Jobs",
                column: "LawyerId");

            migrationBuilder.CreateIndex(
                name: "IX_LawyerJobFields_JobFieldId",
                table: "LawyerJobFields",
                column: "JobFieldId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ReceiverId1",
                table: "Payments",
                column: "ReceiverId1");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_SenderId1",
                table: "Payments",
                column: "SenderId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_LawyerId",
                table: "Sessions",
                column: "LawyerId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPoints_PlatformSubscriptionId",
                table: "SubscriptionPoints",
                column: "PlatformSubscriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSubscriptions_LawyerId",
